...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'zhanglingyu@e5.zhanglingyu.ml',
  ...
  protectedRoutes: ['/自用', '/🥟 Some test files/Protected route'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:mm2v33@outlook.com',
